-- <event type="login" name="Battlefield-Login" script="battlefield.lua"/>
-- <event type="logout" name="Battlefield-Logout" script="battlefield.lua"/>
-- <event type="preparedeath" name="Battlefield" script="battlefield.lua"/>
