-- <event type="login" name="Zombie-Login" script="events/zombie.lua"/>
-- <event type="logout" name="Zombie-Logout" script="events/zombie.lua"/>
-- <event type="healthchange" name="Zombie" script="events/zombie.lua" />
