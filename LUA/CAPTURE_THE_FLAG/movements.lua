-- <movevent event="StepIn" actionid="9619" script="capturetheflag.lua"/>
-- <movevent event="StepIn" actionid="9620" script="capturetheflag.lua"/>
-- <movevent event="StepIn" actionid="9621" script="capturetheflag.lua"/>
