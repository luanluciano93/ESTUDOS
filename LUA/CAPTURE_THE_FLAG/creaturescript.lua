-- <event type="login" name="CaptureTheFlag-Login" script="events/capturetheflag.lua"/>
-- <event type="logout" name="CaptureTheFlag-Logout" script="events/capturetheflag.lua"/>
-- <event type="preparedeath" name="CaptureTheFlag" script="events/capturetheflag.lua"/>
